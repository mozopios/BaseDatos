    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary">
                ...
                <form action="/categoria-array/<?php echo $action; ?>" method="post">
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="id_padre" id="id_padre">
                                        ...
                                        foreach ($categoriasList as $c) {
                                            echo '<option value="' . $c['id_categoria'] . '" ' . (isset($categoria['id_padre']) && $categoria['id_padre'] == $c['id_categoria'] ? 'selected' : '') . '>' . $c['fullName'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                    <?php
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_categoria" id="nombre_categoria" class="form-control" value="<?php echo isset($categoria['nombre_categoria']) ? $categoria['nombre_categoria'] : ''; ?>" />
                                    <?php
                                    if(isset($errors['nombre_categoria'])){
                                    ?>
                                    <p class="text-danger"><small><?php echo $errors['nombre_categoria']; ?></small></p>
                                    <?php
                                    }
                                    ?>
                                </div> 
